...
// MARK: CanvasView
extern "C" fn canvas_view_draw_rect(this: *mut Object, _: *const Sel, _dirty_rect: NSRect) {
    unsafe {
        ...
        let attributes: *mut Object = msg_send![class!(NSDictionary), dictionaryWithObjects:&values forKeys:&keys count:values.len()];
...
// MARK: AppDelegate
extern "C" fn did_finish_launching(_this: *mut Object, _: *const Sel, _: *const Object) {
    unsafe {
        // Create menu
        ...
        let about_menu_item: *mut Object = msg_send![msg_send![class!(NSMenuItem), alloc],
        ...
        // Create window
        let window: *mut Object = msg_send![msg_send![class!(NSWindow), alloc],
...
extern "C" fn open_about(_this: *mut Object, _: *const Sel, _: *const Object) {
    unsafe {
