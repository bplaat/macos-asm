...
define_class!(
    ...
    impl AppDelegate {
        ...
        fn _did_finish_launching(&self, notification: *const Object) { self.did_finish_launching(notification); }

        #[unsafe(method(applicationShouldTerminateAfterLastWindowClosed:))]
        fn _should_terminate_after_last_window_closed(&self, _: *const Object) -> Bool { Bool::YES }

        #[unsafe(method(openAbout:))]
        fn _open_about(&self, _: *const Object) { self.open_about(); }
    }
);
