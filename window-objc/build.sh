...
gcc -x objective-c bassietest.m -framework Cocoa -o BassieTest-arm64 || exit 1
arch -x86_64 gcc -x objective-c bassietest.m -framework Cocoa -o BassieTest-x86_64 || exit 1
