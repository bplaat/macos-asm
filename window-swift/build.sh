...
if [[ $1 = "release" ]]; then
    swiftc -Osize -target arm64-apple-macosx11 src/main.swift -o BassieTest-arm64
    swiftc -Osize -target x86_64-apple-macosx11 src/main.swift -o BassieTest-x86_64
