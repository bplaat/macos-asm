...
pub(crate) const NS_OPENGL_PFA_DOUBLE_BUFFER: u32 = 5;
pub(crate) const NS_OPENGL_PFA_COLOR_SIZE: u32 = 8;
pub(crate) const NS_OPENGL_PFA_ALPHA_SIZE: u32 = 11;
pub(crate) const NS_OPENGL_PFA_ACCELERATED: u32 = 73;
pub(crate) const NS_OPENGL_PFA_OPENGL_PROFILE: u32 = 99;
pub(crate) const NS_OPENGL_PROFILE_VERSION_4_1_CORE: u32 = 0x4100;
pub(crate) const NS_OPENGL_CONTEXT_PARAMETER_SWAP_INTERVAL: isize = 222;
