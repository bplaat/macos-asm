...
if [[ $1 = "release" ]]; then
    clang $CFLAGS -Os --target=arm64-macos src/main.c -framework Cocoa -o BassieTest-arm64
    clang $CFLAGS -Os --target=x86_64-macos src/main.c -framework Cocoa -o BassieTest-x86_64
